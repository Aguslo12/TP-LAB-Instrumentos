...
export const Carrito = () => {
  ...
  return (
    <div className=" flex w-full h-screen fixed justify-end items-end">
      <button onClick={eliminarTodo} className="z-40 inset-0 flex w-20 justify-center items-center btn btn-error h-16 mb-28 mr-1 text-2xl text-white font-semibold rounded">
        <BsCartXFill />
      </button>
